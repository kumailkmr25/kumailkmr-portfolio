    ...
    <AnimatePresence>
      {isVisible && (
        <motion.div
          ...
          className="fixed bottom-0 left-0 right-0 z-40 p-4 md:hidden bg-white/80 dark:bg-[#0a0a0a]/80 backdrop-blur-xl border-t border-black/10 dark:border-white/10 shadow-[0_-10px_40px_rgba(0,0,0,0.1)] dark:shadow-[0_-10px_40px_rgba(0,0,0,0.5)]"
        >
