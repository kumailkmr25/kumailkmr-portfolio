    ...
    <AnimatePresence>
      {loading && (
        <motion.div
          ...
          className="fixed inset-0 z-[200] flex flex-col items-center justify-center bg-white dark:bg-[#0a0a0a]"
        >
            ...
            <div className="h-6 relative overflow-hidden flex items-center justify-center w-64">
              <AnimatePresence mode="popLayout">
                <motion.span
                  ...
                  className="absolute text-sm font-medium text-[#71717a] tracking-wider uppercase text-center w-full"
                >
                  {messages[msgIndex]}
                </motion.span>
              </AnimatePresence>
