...
export function DemoCenter() {
  ...
  return (
    <section className="section-py bg-[#f4f4f5] dark:bg-[#111111] overflow-hidden">
      <div className="section-container max-w-6xl">
              ...
              <button
                ...
                className={`px-4 py-2 rounded-full text-xs font-semibold transition-all ${
                  activeCategory === cat
                    ...
                    : "bg-white dark:bg-[#0a0a0a] text-[#71717a] hover:bg-black/5 dark:hover:bg-white/5 border border-black/5 dark:border-white/5"
                }`}
              >
                {cat}
              </button>
        ...
        <div className="relative w-full aspect-video md:aspect-[21/9] rounded-3xl overflow-hidden glass-card border border-black/10 dark:border-white/10 group cursor-pointer shadow-2xl">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <div className="w-16 h-16 rounded-full bg-black/50 dark:bg-white/10 text-white flex items-center justify-center mb-6 shadow-xl backdrop-blur-md relative">
                  ...
                  <Lock className="w-4 h-4 absolute -bottom-1 -right-1 text-[#a1a1aa] bg-black/80 rounded-full p-0.5" />
                </div>
                ...
                <div className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-black/5 dark:bg-white/5 text-foreground-muted text-sm font-medium border border-black/10 dark:border-white/10">
