      ...
      <div className="section-container max-w-6xl">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-center">
          ...
          <div className="lg:w-1/3 text-center lg:text-left">
            <h2 className="text-3xl md:text-4xl font-bold tracking-tight mb-6 font-sora text-[#09090b] dark:text-white">
          ...
          <div className="lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-4">
            {outcomes.map((item, index) => (
              <motion.div
                ...
                className="flex items-center gap-4 p-4 rounded-xl border border-black/5 dark:border-white/5 bg-[#f4f4f5]/50 dark:bg-[#111111] hover:border-primary/30 transition-colors"
              >
                <div className="w-10 h-10 rounded-lg bg-white dark:bg-[#1a1a1a] border border-black/5 dark:border-white/5 shadow-sm flex items-center justify-center text-primary flex-shrink-0">
                  {item.icon}
                </div>
                <span className="font-semibold text-[#09090b] dark:text-white text-sm md:text-base">
                  {item.title}
                </span>
              </motion.div>
            ))}
