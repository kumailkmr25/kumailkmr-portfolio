...
export function WelcomeBanner() {
 ...
 className="pointer-events-auto relative w-full max-w-lg bg-background border border-white/10 shadow-2xl rounded-2xl overflow-hidden text-center p-8"
 >
 ...
 <p className="text-foreground-muted text-lg leading-relaxed max-w-md mx-auto">
 ...
 <button 
 onClick={handleClose}
 className="mt-2 p-2 text-foreground-muted hover:text-white hover:bg-white/10 rounded-full transition-colors flex items-center justify-center text-sm w-10 h-10"
