        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="mt-16 grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <motion.div
              ...
              className="premium-card p-8 bg-[#f4f4f5] dark:bg-[#111111]"
            >
              <h3 className="text-xl font-bold mb-6 text-[#09090b] dark:text-white">
                How would you like to connect?
              </h3>
              
              <div className="mb-8">
                <label htmlFor="context" className="block text-sm font-medium text-[#09090b] dark:text-[#a1a1aa] mb-2">
                ...
                <textarea
                  ...
                  className="w-full rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-[#0a0a0a] p-4 text-[#09090b] dark:text-white placeholder:text-[#71717a] focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary resize-none transition-colors"
                />
              </div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <button
                  onClick={handleEmail}
                  className="flex items-center gap-3 w-full p-4 rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-[#0a0a0a] text-[#09090b] dark:text-white hover:border-[#09090b] dark:hover:border-white transition-colors"
                >
                ...
                <Link
                  ...
                  target="_blank"
                  className="flex items-center gap-3 w-full p-4 rounded-xl border border-black/10 dark:border-white/10 bg-white dark:bg-[#0a0a0a] text-[#09090b] dark:text-white hover:border-[#0a0a0a] hover:bg-[#0a66c2] hover:text-white dark:hover:border-white dark:hover:bg-[#0a66c2] transition-all group"
                >
              ...
              <div className="mt-8 pt-8 border-t border-black/5 dark:border-white/5 flex items-center gap-4 text-sm text-[#71717a]">
            ...
            >
              <div>
                <h3 className="text-2xl font-bold mb-6 text-[#09090b] dark:text-white">
                  What happens on the call?
                </h3>
                
                <div className="premium-card bg-[#f4f4f5] dark:bg-[#111111] p-6 relative overflow-hidden mb-6">
                  ...
                  <div className="flex flex-col gap-6 relative z-10">
                    {discoverySteps.map((step, idx) => (
                      <div key={idx} className="flex items-center gap-4">
                        ...
                        <span className="text-sm font-medium text-[#09090b] dark:text-white">{step}</span>
                      </div>
                    ))}
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div className="premium-card bg-white dark:bg-[#0a0a0a] p-6 border-l-4 border-l-primary">
                  ...
                  <div className="premium-card bg-white dark:bg-[#0a0a0a] p-6 border-l-4 border-l-red-500">
                    <h4 className="font-bold text-lg mb-2 flex items-center gap-2">
