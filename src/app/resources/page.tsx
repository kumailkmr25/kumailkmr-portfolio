...
export default function ResourcesPage() {
 ...
 className="premium-card p-8 bg-surface flex flex-col relative group"
 >
 <div className="absolute top-6 right-6">
 <Badge variant="gray" className="text-xs">{resource.type}</Badge>
 </div>
 <div className="w-12 h-12 rounded-xl bg-white dark:bg-background flex items-center justify-center text-foreground mb-6 border border-border shadow-sm">
 {resource.icon}
 </div>
 ...
 <p className="text-foreground-muted text-sm leading-relaxed flex-1 mb-8">
 {resource.description}
 </p>
 <button className="flex items-center justify-center gap-2 w-full py-3 rounded-lg border border-border-strong bg-white dark:bg-background text-foreground font-semibold text-sm hover:bg-primary-bg dark:hover:bg-primary-bg hover:border-primary-border dark:hover:border-primary-border transition-colors group-hover:text-primary dark:group-hover:text-primary-light">
