        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
          {expertise.map((item, index) => (
            <motion.div
              ...
              className="p-5 rounded-2xl border border-black/5 dark:border-white/5 bg-[#f4f4f5]/50 dark:bg-[#111111] flex items-start gap-4 hover:bg-white dark:hover:bg-[#1a1a1a] hover:shadow-lg transition-all"
            >
              <div className="w-10 h-10 rounded-lg bg-primary/10 text-primary flex items-center justify-center flex-shrink-0">
                {item.icon}
              </div>
              <div>
                <h4 className="font-semibold text-[#09090b] dark:text-white text-sm mb-1">{item.title}</h4>
