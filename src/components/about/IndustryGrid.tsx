...
export function IndustryGrid() {
  return (
    <section className="py-24 bg-[#f4f4f5] dark:bg-[#111111] border-t border-black/5 dark:border-white/5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
          {industries.map((ind, i) => (
            <motion.div
              ...
              className="group relative p-6 bg-white dark:bg-[#1a1a1a] rounded-2xl border border-black/5 dark:border-white/5 hover:border-primary/50 transition-all cursor-pointer h-40 flex flex-col items-center justify-center text-center overflow-hidden"
            >
              ...
              <div className="transition-transform duration-300 group-hover:-translate-y-8 group-hover:opacity-0 flex flex-col items-center">
                <div className="w-12 h-12 rounded-xl bg-[#f4f4f5] dark:bg-[#222] text-[#71717a] group-hover:text-primary flex items-center justify-center mb-3 transition-colors">
                  {ind.icon}
                </div>
                <span className="font-semibold text-[#09090b] dark:text-white text-sm">
                  {ind.name}
                </span>
              </div>
