              ...
              <button
                ...
                className={`flex-shrink-0 snap-center flex items-center gap-2 px-5 py-3 rounded-full text-sm font-medium transition-all duration-300 border ${
                  isActive 
                    ...
                    : "bg-[#f4f4f5] dark:bg-[#111111] text-[#71717a] border-black/5 dark:border-white/5 hover:bg-black/5 dark:hover:bg-white/5"
                }`}
              >
        ...
        <div className="mt-8 relative min-h-[500px]">
          <AnimatePresence mode="wait">
            <motion.div
              ...
              className="glass-card premium-card overflow-hidden bg-[#f4f4f5]/50 dark:bg-[#111111]/50"
            >
              <div className="grid grid-cols-1 lg:grid-cols-2">
                {/* Left: Problems & Impact */}
                <div className="p-8 md:p-12 border-b lg:border-b-0 lg:border-r border-black/5 dark:border-white/5">
                  <div className="flex items-center gap-4 mb-8">
                    ...
                    <div>
                      ...
                      <p className="text-[#71717a]">Common Operational Bottlenecks</p>
                    </div>
                  </div>

                  <div className="space-y-4">
                    {activeIndustry.problems.map((prob, idx) => (
                      <div key={idx} className="flex items-start gap-3 p-4 bg-white dark:bg-[#0a0a0a] rounded-xl border border-black/5 dark:border-white/5 shadow-sm">
                ...
                <div className="p-8 md:p-12 bg-white dark:bg-[#0a0a0a]">
                  ...
                  <h5 className="font-semibold mb-4 text-[#09090b] dark:text-white">Business Outcomes:</h5>
                  <ul className="space-y-3 mb-10">
                    {activeIndustry.outcomes.map((outcome, idx) => (
                      <li key={idx} className="flex items-start gap-3">
                        ...
                        <span className="text-sm font-medium text-[#71717a]">{outcome}</span>
                      </li>
                    ))}
                  </ul>
