...
export function MediaShowcase({ items }: MediaShowcaseProps) {
 ...
 className="group relative rounded-2xl overflow-hidden cursor-pointer bg-white/5 border border-border-strong aspect-video hover:border-primary/50 transition-all"
 >
 {/* Thumbnail / Image */}
 <div className="absolute inset-0 bg-surface animate-pulse -z-10" />
