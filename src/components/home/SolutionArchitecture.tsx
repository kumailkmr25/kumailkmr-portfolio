...
export function SolutionArchitecture() {
 ...
 <div className="premium-card p-6 bg-white dark:bg-background border-l-4 border-l-primary">
 ...
 <div className="premium-card p-6 bg-white dark:bg-background border-l-4 border-l-blue-500">
 ...
 >
 <div className="w-full max-w-sm premium-card bg-white dark:bg-background p-4 flex items-center gap-4 hover:border-primary-border dark:hover:border-primary-border transition-colors shadow-sm">
