        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
          {demoVideos.map((video, i) => (
            ...
            >
              ...
              <div className="p-5 flex flex-col gap-2 bg-white dark:bg-[#0a0a0a]">
        ...
        {selectedVideo && (
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
            ...
            <motion.div
              ...
              className="relative w-full max-w-md bg-white dark:bg-[#111111] rounded-2xl shadow-2xl overflow-hidden z-10"
            >
              ...
              <div className="p-6 flex flex-col items-center text-center gap-4">
                ...
                <button
                  onClick={() => setSelectedVideo(null)}
                  className="mt-2 text-sm text-[#71717a] hover:text-[#09090b] dark:hover:text-white"
                >
                  Close
                </button>
              </div>
