                  ...
                  <button
                    ...
                    className={`w-full max-w-[280px] p-4 flex items-center gap-4 rounded-xl border transition-all duration-300 ${
                      isActive 
                        ...
                        : isPast 
                          ? "bg-white dark:bg-[#0a0a0a] border-primary/50 text-foreground" 
                          : "bg-white dark:bg-[#0a0a0a] border-black/5 dark:border-white/5 text-[#71717a] hover:border-primary/30"
                    }`}
                  >
            ...
            <AnimatePresence mode="wait">
              {activeNodeData && (
                ...
                >
                  ...
                  <div className="flex items-center gap-2 text-xs font-semibold text-[#71717a] uppercase tracking-widest border-t border-black/5 dark:border-white/5 pt-6 mt-6">
