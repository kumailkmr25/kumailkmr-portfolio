      ...
      <div className="section-container">
        ...
        <div className="relative mt-16 max-w-3xl mx-auto"
          ...
          <div className="relative min-h-[300px] flex items-center justify-center">
            <AnimatePresence mode="wait" custom={direction}>
              ...
              >
                ...
                <p className="text-lg md:text-xl text-[#09090b] dark:text-white italic leading-relaxed">
                ...
                <div className="flex flex-col items-center gap-3 mt-4">
                  ...
                  <div className="flex flex-col">
                    <span className="font-bold text-[#09090b] dark:text-white text-lg">
          ...
          <div className="flex items-center justify-center gap-6 mt-8">
            <button 
              onClick={handlePrev}
              className="w-10 h-10 rounded-full border border-black/10 dark:border-white/10 flex items-center justify-center text-[#71717a] hover:text-[#09090b] dark:hover:text-white hover:bg-[#f4f4f5] dark:hover:bg-[#111111] transition-all"
            >
