...
export default async function GenericServicePage(props: PageProps) {
 ...
 {/* 1. HERO SECTION */}
 <section className="section-container relative border-b border-border pb-20">
 <Link 
 href="/services" 
 className="inline-flex items-center gap-2 text-foreground-muted hover:text-foreground dark:hover:text-white mb-8 transition-colors text-sm font-medium"
 >
 ...
 <h1 className="text-4xl md:text-6xl md:leading-tight font-bold tracking-tight text-foreground mb-6">
 {service.title}
 </h1>
 <p className="text-xl text-foreground-muted leading-relaxed mb-10 max-w-3xl">
 {service.description}
 </p>
 ...
 <div className="mt-8 prose dark:prose-invert text-foreground-muted">
 <p>
 ...
 <h3 className="font-bold text-xl text-foreground ">Common Business Challenges</h3>
 </div>
 ...
 <div key={i} className="premium-card p-6 bg-white dark:bg-background">
 <div className="w-10 h-10 rounded-xl bg-primary/10 text-primary flex items-center justify-center mb-4">
 <Check className="w-5 h-5" />
 </div>
 <h4 className="font-bold text-foreground mb-2">{feature}</h4>
 <p className="text-sm text-foreground-muted">Engineered to seamlessly integrate into your workflow, enhancing productivity and accuracy.</p>
 </div>
 ))}
 </div>

 {/* Business Benefits */}
 <div className="mt-16 bg-surface rounded-3xl p-8 lg:p-12 border border-border ">
 <h3 className="text-2xl font-bold text-foreground mb-8 text-center">Measurable Business Benefits</h3>
 ...
 <p className="text-foreground dark:text-foreground-muted font-medium leading-relaxed">{benefit}</p>
 </div>
 ))}
 </div>
 </div>
 ...
 <h3 className="font-bold text-xl text-foreground ">Technology Ecosystem</h3>
 </div>
 <p className="text-sm text-foreground-muted mb-6">We choose technology based strictly on business value, stability, and scale.</p>
 <ul className="flex flex-col gap-4">
 ...
 <p className="text-foreground-muted text-sm mt-1">I don&apos;t just write code; I solve operational bottlenecks.</p>
 </div>
 </li>
 <li className="flex gap-4">
 ...
 <p className="text-foreground-muted text-sm mt-1">No generic cookie-cutter templates. Everything is tailored to your workflow.</p>
 </div>
 </li>
 <li className="flex gap-4">
 ...
 <p className="text-foreground-muted text-sm mt-1">Built to handle 10x your current volume without breaking a sweat.</p>
 </div>
 </li>
 <li className="flex gap-4">
 ...
 <p className="text-foreground-muted text-sm mt-1">Clear timelines, no technical jargon, and absolute transparency.</p>
 </div>
 </li>
 <li className="flex gap-4">
 ...
 <p className="text-foreground-muted text-sm mt-1">I stick around to ensure the system evolves alongside your business.</p>
 </div>
 </li>
 </ul>
 </div>
 ...
 {/* 13. RELATED SERVICES */}
 <section className="section-container mt-32 border-t border-border pt-32">
 <SectionHeading title="Related Services" subtitle="Explore other ways to automate your business." />
 <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
 {relatedServices.map((rs, i) => (
 <Link key={i} href={rs.href || `/services/${rs.id}`} className="premium-card p-6 bg-surface hover:border-primary/50 transition-colors group">
 ...
 <p className="text-sm text-foreground-muted line-clamp-2">{rs.description}</p>
 </Link>
 ))}
 </div>
 </section>
