        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mt-16">
          {outcomes.map((outcome, i) => (
            <motion.div
              ...
              className="premium-card p-6 md:p-8 flex flex-col h-full bg-[#f4f4f5] dark:bg-[#111111]"
            >
              ...
              <h3 className="font-bold text-xl text-[#09090b] dark:text-white mb-3">
                {outcome.title}
              </h3>
              ...
              <div className="mt-auto pt-4 border-t border-black/5 dark:border-white/5">
                <span className="text-sm font-semibold text-[#09090b] dark:text-[#a1a1aa] flex items-center gap-2">
