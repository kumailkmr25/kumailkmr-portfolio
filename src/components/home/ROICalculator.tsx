...
export function ROICalculator() {
 ...
 <div className="glass-card premium-card p-6 md:p-8 space-y-8 bg-surface/50 /50">
 ...
 className="w-full accent-primary h-2 bg-black/10 dark:bg-white/10 rounded-lg appearance-none cursor-pointer"
 />
 <p className="text-xs text-foreground-muted mt-2">Data entry, copy-pasting, answering FAQs, chasing documents.</p>
 </div>
 ...
 <h4 className="text-foreground-muted font-semibold text-sm uppercase tracking-wider mb-2">Potential ROI</h4>
 <div className="flex items-end gap-2 mb-8">
 <h3 className="text-5xl md:text-6xl font-sora font-bold text-foreground">
 ${costSavingsPerYear.toLocaleString()}
 </h3>
 <span className="text-lg text-foreground-muted font-medium mb-1">/ year saved</span>
 </div>

 <div className="grid grid-cols-2 gap-4 mb-8">
 <div className="p-4 bg-white dark:bg-background rounded-xl border border-border ">
