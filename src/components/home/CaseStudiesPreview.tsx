...
export function CaseStudiesPreview() {
 ...
 <p className="text-foreground-muted text-lg md:text-xl max-w-xl font-light">
 ...
 <div className="relative h-full bg-background rounded-[22px] p-8 md:p-10 flex flex-col border border-white/5 group-hover:border-primary-border transition-colors duration-500 z-10 overflow-hidden">
 ...
 <div className="px-3 py-1 text-xs font-semibold text-foreground-muted bg-white/5 rounded-full border border-white/10">
 {cs.label}
 </div>
 </div>
 ...
 <span key={tag} className="text-xs text-foreground-muted font-medium tracking-wide uppercase">
 {tag}
 </span>
 ))}
 </div>
