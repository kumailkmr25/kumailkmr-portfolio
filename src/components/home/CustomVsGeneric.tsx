...
export function CustomVsGeneric() {
 ...
 <div className="mt-16 premium-card bg-white dark:bg-background overflow-hidden">
 <div className="grid grid-cols-1 md:grid-cols-12 border-b border-border bg-surface ">
 <div className="md:col-span-3 p-6 flex items-center">
 <span className="font-bold text-foreground-muted uppercase tracking-wider text-xs">Comparison</span>
 </div>
 <div className="md:col-span-4 p-6 border-t md:border-t-0 md:border-l border-border bg-red-50/30 dark:bg-red-950/10">
 <Badge variant="gray" className="mb-2">Off-The-Shelf SaaS</Badge>
 <h3 className="font-bold text-lg">Generic Software</h3>
 </div>
 <div className="md:col-span-5 p-6 border-t md:border-t-0 md:border-l border-border bg-primary-bg/50 dark:bg-primary-bg">
 ...
 className="grid grid-cols-1 md:grid-cols-12 border-b border-border last:border-b-0"
 >
 <div className="md:col-span-3 p-6 flex items-center bg-surface/50 /50">
 <span className="font-semibold text-foreground ">{row.feature}</span>
 </div>
 
 <div className="md:col-span-4 p-6 border-t md:border-t-0 md:border-l border-border flex gap-3">
 <X className="w-5 h-5 text-red-400 flex-shrink-0 mt-0.5" />
 <span className="text-sm text-foreground-muted leading-relaxed">{row.generic}</span>
 </div>
 
 <div className="md:col-span-5 p-6 border-t md:border-t-0 md:border-l border-border flex gap-3 bg-primary-bg/10 dark:bg-primary-bg">
 <Check className="w-5 h-5 text-primary flex-shrink-0 mt-0.5" />
 <span className="text-sm text-foreground dark:text-foreground-muted leading-relaxed font-medium">{row.custom}</span>
 </div>
 </motion.div>
 ))}
 </div>
