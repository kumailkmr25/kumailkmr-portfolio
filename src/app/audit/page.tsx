    ...
    <>
      <main className="bg-[#f4f4f5] dark:bg-[#111111] min-h-screen">
        <section className="section-py section-container pt-32 max-w-4xl">
          ...
          <div className="mt-16 bg-white dark:bg-[#0a0a0a] rounded-3xl p-8 md:p-12 shadow-sm border border-black/5 dark:border-white/5 min-h-[400px] flex flex-col relative overflow-hidden">
            {!isAnalyzing && !showResults && (
              <>
                ...
                <AnimatePresence mode="wait">
                  ...
                  >
                    <h3 className="text-2xl md:text-3xl font-bold mb-8 text-[#09090b] dark:text-white leading-tight">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      {questions[currentStep].options.map((option, i) => (
                        <button
                          ...
                          className="text-left p-6 rounded-xl border border-black/10 dark:border-white/10 hover:border-primary dark:hover:border-primary hover:bg-primary-bg dark:hover:bg-primary-bg transition-all group"
                        >
                          <span className="font-medium text-[#09090b] dark:text-white group-hover:text-primary dark:group-hover:text-primary-light">
                            {option}
                          </span>
                        </button>
                      ))}
                ...
                {currentStep > 0 && (
                  <button 
                    ...
                    className="mt-8 text-sm text-[#71717a] hover:text-[#09090b] dark:hover:text-white self-start"
                  >
                    ← Back
                  </button>
                )}
            ...
            {isAnalyzing && (
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-[#71717a]">Mapping bottlenecks and identifying AI opportunities</p>
                </div>
              </motion.div>
            )}
            ...
            {showResults && (
              ...
              >
                ...
                <div className="bg-primary-bg dark:bg-primary-bg border border-primary-border dark:border-primary-border rounded-2xl p-6 md:p-8 mb-8">
                  ...
                  <p className="text-[#09090b] dark:text-white leading-relaxed">
                    {getRecommendation().description}
                  </p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
                  <div className="p-6 rounded-xl border border-black/5 dark:border-white/5 bg-[#f4f4f5] dark:bg-[#111111]">
                    <h4 className="font-semibold mb-2">Potential Time Saved</h4>
                    <p className="text-2xl font-bold text-[#09090b] dark:text-white">15-20 Hours/Week</p>
                  </div>
                  <div className="p-6 rounded-xl border border-black/5 dark:border-white/5 bg-[#f4f4f5] dark:bg-[#111111]">
                    <h4 className="font-semibold mb-2">Implementation Complexity</h4>
                    <p className="text-2xl font-bold text-[#09090b] dark:text-white">Low-Medium</p>
                  </div>
                </div>

                <div className="mt-auto text-center border-t border-black/5 dark:border-white/5 pt-8">
