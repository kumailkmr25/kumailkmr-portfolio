...
export function ProblemSelector() {
 ...
 : "bg-surface-2 text-foreground-muted border-border hover:border-primary/30 hover:text-foreground"
 }`}
 >
 {p.title}
 </button>
 ...
 <h4 className="text-foreground-muted font-semibold text-sm uppercase tracking-wider mb-2">Recommended Solution</h4>
