...
export function TechEcosystem() {
 ...
 viewport={{ once: true }}
 className="w-full sm:w-2/3 p-6 rounded-2xl bg-surface border border-border flex items-center justify-center gap-4 z-10"
 >
 <Building className="w-8 h-8 text-foreground-muted" />
 <span className="font-bold text-lg text-foreground ">Your Business Data</span>
 </motion.div>
 ...
 >
 <div className="p-6 rounded-2xl bg-surface-2 border border-border-strong shadow-lg flex flex-col items-center justify-center gap-3 text-center">
 ...
 <h3 className="font-bold text-xl text-foreground relative z-10">AI & Automation Layer</h3>
 <p className="text-sm text-foreground-muted text-center mt-2 relative z-10">Intelligent Routing • Contextual Memory • Automated Responses</p>
 </motion.div>
 ...
 className="w-full grid grid-cols-2 gap-4 z-10"
 >
 <div className="p-6 rounded-2xl bg-surface border border-border flex flex-col items-center justify-center gap-3 text-center">
