...
export function ReadinessQuiz() {
 ...
 className="w-full"
 >
 <div className="text-sm font-bold tracking-widest text-foreground-muted uppercase mb-4">
 ...
 className="w-full text-left p-5 rounded-xl border border-border-strong bg-white dark:bg-background hover:border-primary/50 hover:bg-primary/5 transition-all text-foreground font-medium group"
 >
 ...
 <button 
 onClick={resetQuiz}
 className="flex items-center justify-center gap-2 px-8 py-4 bg-surface text-foreground font-semibold rounded-xl hover:bg-black/5 dark:hover:bg-white/5 transition-colors w-full sm:w-auto"
 >
