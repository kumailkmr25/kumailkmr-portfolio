          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-16">
            {industryWorkflows.map((industry, i) => (
              <motion.div
                ...
                className="premium-card p-8 flex flex-col bg-white dark:bg-[#0a0a0a]"
              >
                <div className="flex items-center gap-4 mb-8 border-b border-black/5 dark:border-white/5 pb-6">
                  ...
                  <h2 className="text-2xl font-bold text-[#09090b] dark:text-white">
                    {industry.name}
                  </h2>
                </div>

                <div className="flex-1">
                  <h4 className="font-semibold text-sm text-[#71717a] uppercase tracking-wider mb-6">
                    ...
                    {industry.workflow.map((step, idx) => (
                      <div key={idx} className="flex gap-4 relative z-10">
                        ...
                        <div className="pt-0.5">
                          <p className="text-sm font-medium text-[#09090b] dark:text-[#a1a1aa] leading-relaxed">
                            {step}
                          </p>
                        </div>
                      </div>
