          ...
          {categories.map((cat) => (
            <button
              ...
              className={cn(
                ...
                activeTab === cat.id
                  ? "bg-[#09090b] dark:bg-white text-white dark:text-[#09090b] border-transparent"
                  : "bg-white dark:bg-[#0a0a0a] text-[#71717a] border-black/10 dark:border-white/10 hover:border-black/20 dark:hover:border-white/20 hover:text-[#09090b] dark:hover:text-white"
              )}
            >
              {cat.label}
            </button>
            ...
            {filteredServices.map((service) => {
              ...
              const CardContent = (
                <>
                  ...
                  <h3 className="text-xl font-bold text-[#09090b] dark:text-white mb-3 flex items-center justify-between">
                    {service.title}
