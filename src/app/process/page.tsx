...
export default function ProcessPage() {
 ...
 >
 {/* Step Node */}
 <div className="absolute left-[36px] md:left-1/2 top-1/2 -translate-y-1/2 -translate-x-1/2 w-16 h-16 rounded-full bg-background border border-white/10 flex items-center justify-center shadow-[0_0_30px_rgba(16,185,129,0.15)] z-20 group-hover:border-primary-border transition-colors">
 ...
 <div className="bg-background rounded-[31px] p-8 md:p-12 border border-white/5 group-hover:border-primary-border transition-all duration-500 relative overflow-hidden">
 ...
 <span className="w-fit px-4 py-1.5 rounded-full border border-white/10 bg-white/5 text-xs font-semibold text-foreground-muted tracking-widest uppercase">
 {step.duration}
 </span>
 </div>
 
 <p className="text-foreground-muted text-lg leading-relaxed relative z-10 font-light group-hover:text-white/80 transition-colors">
 {step.description}
 </p>
 </div>
 </div>
 ...
 <p className="text-foreground-muted text-lg">Clear answers on timelines, ownership, and integrations.</p>
 </div>
...
function FAQItem({ faq }: { faq: { question: string; answer: string } }) {
 ...
 <ChevronDown
 className={cn(
 "w-5 h-5 text-foreground-muted transition-transform duration-300 flex-shrink-0 group-hover:text-primary-light",
 isOpen ? "rotate-180" : ""
 )}
 />
 </button>
 ...
 >
 <div className="px-6 md:px-8 pb-6 md:pb-8 pt-0 text-base md:text-lg text-foreground-muted leading-relaxed font-light">
 {faq.answer}
 </div>
 </motion.div>
 )}
