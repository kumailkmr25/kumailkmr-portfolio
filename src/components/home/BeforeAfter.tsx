...
export function BeforeAfter() {
 return (
 <section className="section-py bg-white dark:bg-background overflow-hidden">
 ...
 <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 rounded-full bg-white dark:bg-background border border-border-strong z-20 items-center justify-center font-bold text-foreground-muted shadow-lg">
 VS
 </div>
 ...
 <p className="text-foreground-muted text-sm">You are the bottleneck in your own business.</p>
 </div>
 ...
 <p className="text-foreground-muted text-sm">Systems run seamlessly in the background.</p>
 </div>
