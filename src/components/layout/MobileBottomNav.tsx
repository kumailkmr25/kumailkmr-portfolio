...
export function MobileBottomNav() {
 ...
 return (
 <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 bg-background/90 dark:bg-background/90 backdrop-blur-lg border-t border-border-strong pb-safe">
 ...
 className="flex flex-col items-center justify-center w-full h-full space-y-1 text-foreground-muted hover:text-primary-light transition-colors"
 >
